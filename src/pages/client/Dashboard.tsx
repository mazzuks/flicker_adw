              ...
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h2 className="text-2xl font-bold">
                    Sua empresa está {progress.percentage}% pronta
                  </h2>
                  <p className="text-blue-100 mt-1 font-medium italic opacity-80">
                    Finalize o onboarding para iniciarmos o CNPJ.
                  </p>
                </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          {!subscription || subscription.status !== 'ACTIVE' ? (
            ...
            <div className="bg-adworks-dark rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden group border border-green-500/20">
              ...
              <p className="text-gray-400 text-sm font-black uppercase tracking-widest mb-1 italic">
                {subscription.plan?.name}
              </p>
              <p className="text-adworks-accent text-2xl font-black tracking-tighter">
              ...
              <div className="mt-8 pt-8 border-t border-white/5 flex justify-between items-center">
                ...
                <Link
                  to="/client/account"
                  className="text-[10px] font-black text-adworks-blue hover:underline uppercase"
                >
                  Gerenciar
                </Link>
              </div>
            ...
            <div className="space-y-4">
              ...
              {(!subscription || subscription.status !== 'ACTIVE') && (
                <div className="p-6 bg-orange-50 border border-orange-100 rounded-3xl">
                  <p className="font-black text-orange-700 uppercase text-xs italic mb-1">
                    Pagamento Pendente
                  </p>
              ...
              <div className="p-6 bg-adworks-gray/50 rounded-3xl opacity-60">
                <p className="font-black text-gray-500 uppercase text-xs italic mb-1">

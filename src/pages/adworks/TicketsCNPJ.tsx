        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-[2.5rem] w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
            <div className="p-8 border-b border-gray-100 flex items-center justify-between bg-adworks-gray/30">
              <div>
                <span className="text-[10px] font-black text-adworks-blue uppercase tracking-widest bg-blue-50 px-3 py-1 rounded-full">
                  Dossier do Cliente
                </span>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8">
                ...
                <div className="bg-adworks-gray/50 rounded-3xl p-6 border border-gray-100">
                  ...
                  <div className="space-y-3">
                    <p className="text-sm">
                      ...
                      <br />
                      <span className="font-black text-adworks-dark">
                        {selectedTicket.data_json?.fantasy_name || 'N/A'}
                      </span>
                    </p>
                    <p className="text-sm">
                      <span className="text-gray-400 font-bold uppercase text-[9px] tracking-widest">
                      ...
                      <br />
                      <span className="font-black text-adworks-dark uppercase italic">
                        {selectedTicket.data_json?.segment || 'N/A'}
                      </span>
                    </p>
                    <p className="text-sm">
                      <span className="text-gray-400 font-bold uppercase text-[9px] tracking-widest">
                      ...
                      <br />
                      <span className="font-black text-adworks-dark">
                        {selectedTicket.data_json?.city} / {selectedTicket.data_json?.state}
                      </span>
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-adworks-gray/50 rounded-3xl p-6 border border-gray-100">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`text-[10px] font-black uppercase px-2 py-1 rounded-full border ${getPriorityColor(selectedTicket.priority)}`}
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-black text-adworks-dark">
                        {selectedTicket.sla_due_at
                          ? new Date(selectedTicket.sla_due_at).toLocaleDateString('pt-BR')
                          : 'Sem prazo'}
                      </span>
                    </div>
                  </div>
              ...
              <div className="bg-adworks-dark rounded-3xl border border-white/5 p-8 shadow-2xl relative overflow-hidden group">
                ...
                <h3 className="text-sm font-black text-gray-400 uppercase mb-6 tracking-[0.2em] relative z-10">
                  Dossiê Completo (Engine JSON)
                </h3>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium tracking-tight">
            Gestão de processos de abertura e regularização.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        {[
          ...
          },
          {
            key: 'WAITING_CLIENT',
            label: 'Aguardando',
            count: statusCounts.WAITING_CLIENT,
            color: 'orange-500',
          },
          ...
          >
            <p
              className={`text-3xl font-black tracking-tighter mb-1 ${selectedStatus === s.key ? `text-${s.color}` : 'text-adworks-dark'}`}
            >
              {s.count}
            </p>
              ...
              <tbody className="divide-y divide-gray-50">
                {tickets.map((ticket) => (
                  <tr key={ticket.id} className="group hover:bg-adworks-gray/30 transition-all">
                    ...
                    <td className="px-8 py-6">
                      <span
                        className={`text-[10px] font-black uppercase tracking-widest ${getPriorityColor(ticket.priority)}`}
                      >
                        {ticket.priority}
                      </span>
                    </td>

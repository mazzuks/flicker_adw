    ...
    <div className="space-y-10 animate-in fade-in duration-500 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 pb-8 border-b border-adworks-border">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold text-adworks-dark tracking-tight leading-none">
            Command Center
          </h1>
          <p className="text-adworks-muted text-sm font-medium">
            Relatórios e inteligência de mercado em tempo real.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center bg-adworks-accent border border-adworks-border rounded-xl px-4 py-2 text-adworks-muted gap-3 hover:border-adworks-blue/30 transition-all cursor-text w-64">
            ...
            <kbd className="bg-white border border-adworks-border rounded px-1.5 py-0.5 text-[9px] font-black tracking-tighter">
              ⌘K
            </kbd>
          </div>
          ...
          <div className="flex items-center bg-adworks-surface border border-adworks-border rounded-xl px-4 py-2 shadow-adw-flat cursor-pointer hover:bg-adworks-accent transition-colors">
            ...
            <span className="text-xs font-bold text-adworks-dark uppercase tracking-wider">
              Fevereiro / 2026
            </span>
        ...
        <div className="lg:col-span-2 bg-adworks-blue rounded-adw-lg p-10 text-white shadow-2xl shadow-blue-500/10 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex items-start justify-between mb-10">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.25em] mb-3 text-blue-200">
                  Pipeline Financeiro Global
                </p>
                <h3 className="text-5xl font-bold tracking-tighter leading-none italic">
                  R$ 5.240.800,00
                </h3>
              </div>
            ...
            <div className="flex flex-wrap gap-8 items-center pt-10 border-t border-white/10">
              <div>
                <p className="text-[9px] font-black uppercase tracking-widest text-blue-200 mb-1">
                  Win Rate
                </p>
        ...
        <div className="space-y-6">
          <div className="bg-adworks-surface p-8 rounded-adw-lg border border-adworks-border shadow-adw-flat hover:border-adworks-blue/20 transition-all group">
            <div className="flex items-center justify-between mb-4">
              <p className="text-[10px] font-black text-adworks-muted uppercase tracking-widest italic">
                Ticket Médio
              </p>
              <ArrowUpRight className="w-4 h-4 text-green-500" />
            </div>
            <h4 className="text-3xl font-bold text-adworks-dark tracking-tighter">R$ 3.250</h4>
            <p className="text-[9px] font-bold text-green-600 uppercase mt-2">
              +R$ 150 vs último mês
            </p>
          </div>
          <div className="bg-adworks-surface p-8 rounded-adw-lg border border-adworks-border shadow-adw-flat hover:border-adworks-blue/20 transition-all group">
            ...
            <p className="text-[9px] font-bold text-adworks-blue uppercase mt-2">
              -1.2 dias de média
            </p>
          </div>
        </div>
      ...
      <div className="bg-adworks-surface rounded-adw-lg p-10 border border-adworks-border shadow-adw-flat">
        <div className="flex items-center justify-between mb-12">
          <div>
            <h3 className="text-xl font-bold text-adworks-dark tracking-tight uppercase italic leading-none">
              Fluxo de Performance Histórica
            </h3>
            <p className="text-adworks-muted text-[10px] font-black uppercase tracking-[0.2em] mt-3">
              Análise de Receita Ganhos - 12 Meses
            </p>
          </div>
          <div className="flex bg-adworks-accent p-1 rounded-xl">
            {['Mês', 'Semana', 'Dia'].map((t) => (
              <button
                key={t}
                className={`px-5 py-2 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all ${t === 'Mês' ? 'bg-white text-adworks-blue shadow-sm' : 'text-adworks-muted hover:text-adworks-dark'}`}
              >
                {t}
              </button>
            ))}
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={DATA_WON}>
              ...
              <Area
                ...
                fillOpacity={1}
                fill="url(#colorVal)"
                activeDot={{ r: 8, fill: '#0047FF', strokeWidth: 4, stroke: '#fff' }}
              />
            </AreaChart>
          </ResponsiveContainer>
        </div>

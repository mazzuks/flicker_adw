      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <span className="bg-adworks-blue text-white px-3 py-1 rounded-full text-[9px] font-black tracking-widest uppercase shadow-lg shadow-blue-500/20">
          ...
          <p className="text-gray-400 font-bold text-xs uppercase tracking-widest">
            Acompanhamento de ROI, crescimento e saúde do ecossistema.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 bg-white rounded-[2.5rem] p-10 shadow-adw-soft border border-gray-100">
          <div className="flex items-center justify-between mb-10">
            <h2 className="text-xl font-black text-[#2D3E50] uppercase italic tracking-tighter">
              Crescimento de Receita
            </h2>
            <div className="flex items-center gap-4 text-[9px] font-black text-gray-400">
              <span className="flex items-center gap-1.5 uppercase">
                <div className="w-2 h-2 rounded-full bg-adworks-blue"></div> Revenue
              </span>
            </div>
          </div>
        ...
        <div className="lg:col-span-4 bg-white rounded-[2.5rem] p-10 shadow-adw-soft border border-gray-100 flex flex-col justify-between">
          <h3 className="text-sm font-black text-[#2D3E50] uppercase tracking-widest italic mb-8">
            Origem dos Clientes
          </h3>
          ...
          <div className="space-y-3 mt-8">
            {SOURCE_DATA.map((item, i) => (
              <div
                key={i}
                className="flex items-center justify-between p-3 bg-[#F8FAFC] rounded-2xl border border-transparent hover:border-[#E2E8F0] transition-all"
              >
                <div className="flex items-center gap-3">
                  <div
